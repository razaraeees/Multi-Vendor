        ...
        <section class="py-3 border-bottom border-top d-none d-md-flex bg-light">
            <div class="container">
                <div class="page-breadcrumb d-flex align-items-center">
                    <h3 class="breadcrumb-title pe-3"><?php echo e($productDetails['product_name']); ?></h3>
                    <div class="ms-auto">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                <li class="breadcrumb-item"><a href="<?php echo e(url('/')); ?>"><i class="bx bx-home-alt"></i> Home</a>
                                </li>
                                <li class="breadcrumb-item"><a href="<?php echo e(url('/shop')); ?>">Shop</a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page"><?php echo e($productDetails['product_name']); ?></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="row g-0">
                                ...
                                <div class="image-zoom-section">
                                    <div class="product-gallery owl-carousel owl-theme border mb-3 p-3" data-slider-id="1">
                                        ...
                                        <div class="item">
                                            <a href="<?php echo e(asset('front/images/product_images/large/' . $productDetails['product_image'])); ?>"
                                                class="easyzoom"
                                                data-standard="<?php echo e(asset('front/images/product_images/small/' . $productDetails['product_image'])); ?>">
                                                <img src="<?php echo e(asset('front/images/product_images/large/' . $productDetails['product_image'])); ?>"
                                                    class="img-fluid" alt="<?php echo e($productDetails['product_name']); ?>">
                                            </a>
                                        </div>
                                        ...
                                        <?php $__currentLoopData = $productDetails['images']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="item">
                                                <a href="<?php echo e(asset('front/images/product_images/large/' . $image['image'])); ?>"
                                                    class="easyzoom"
                                                    data-standard="<?php echo e(asset('front/images/product_images/small/' . $image['image'])); ?>">
                                                    <img src="<?php echo e(asset('front/images/product_images/large/' . $image['image'])); ?>"
                                                        class="img-fluid" alt="<?php echo e($productDetails['product_name']); ?>">
                                                </a>
                                            </div>
                                    ...
                                    <div class="owl-thumbs d-flex justify-content-center mt-2" data-slider-id="1">
                                        ...
                                        <button class="owl-thumb-item border-0 bg-transparent p-0">
                                            <img src="<?php echo e(asset('front/images/product_images/small/' . $productDetails['product_image'])); ?>"
                                                width="60" alt="<?php echo e($productDetails['product_name']); ?>">
                                        </button>
                            ...
                            <div class="col-12 col-lg-7">
                                <div class="product-info-section p-3">
                                    <h3 class="mt-3 mt-lg-0 mb-0"><?php echo e($productDetails['product_name']); ?></h3>

                                    <div class="product-rating d-flex align-items-center mt-2">
                                        <div class="rates cursor-pointer font-13">
                                            <?php for($i = 1; $i <= 5; $i++): ?>
                                                <i
                                                    class="bx bxs-star <?php echo e($i <= $avgStarRating ? 'text-warning' : 'text-light-4'); ?>"></i>
                                            <?php endfor; ?>
                                        </div>
                                        <div class="ms-1">
                                            <p class="mb-0">(<?php echo e(count($ratings)); ?> Ratings)</p>
                                        </div>
                                    </div>

                                    <div class="d-flex align-items-center mt-3 gap-2">
                                        <?php if($productDetails['product_discount'] > 0): ?>
                                            <h5 class="mb-0 text-decoration-line-through text-light-3">
                                                $<?php echo e($productDetails['product_price']); ?></h5>
                                            <h4 class="mb-0">
                                                $<?php echo e($productDetails['product_price'] - ($productDetails['product_price'] * $productDetails['product_discount']) / 100); ?>

                                            </h4>
                                        <?php else: ?>
                                            <h4 class="mb-0">$<?php echo e($productDetails['product_price']); ?></h4>
                                        <?php endif; ?>
                                    </div>

                                    <div class="mt-3">
                                        <h6>Description :</h6>
                                        <p class="mb-0"><?php echo e($productDetails['description']); ?></p>
                                    </div>

                                    <dl class="row mt-3">
                                        <dt class="col-sm-3">Product ID</dt>
                                        <dd class="col-sm-9"><?php echo e($productDetails['id']); ?></dd>
                                        <dt class="col-sm-3">Delivery</dt>
                                        <dd class="col-sm-9"><?php echo e($productDetails['delivery_info'] ?? 'Worldwide'); ?></dd>
                                    </dl>
                                        ...
                                        <div class="row row-cols-auto align-items-center mt-3">
                                            ...
                                            <div class="col">
                                                ...
                                                <select class="form-select form-select-sm" name="size" required>
                                                    ...
                                                    <?php $__currentLoopData = $productDetails['attributes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attribute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($attribute['size']); ?>"><?php echo e($attribute['size']); ?>
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="color-indigators d-flex align-items-center gap-2">
                                                    <?php $__currentLoopData = $groupProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <a href="<?php echo e(url('product/' . $gp['id'])); ?>">
                                                            <div class="color-indigator-item"
                                                                style="background-image: url('<?php echo e(asset('front/images/product_images/small/' . $gp['product_image'])); ?>'); background-size: cover;">
                                                            </div>
                                                        </a>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </div>
...
<?php echo $__env->make('front.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\multi-vendor\resources\views/front/products/detail.blade.php ENDPATH**/ ?>