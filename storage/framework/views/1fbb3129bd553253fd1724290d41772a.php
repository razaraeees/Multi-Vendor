                    ...
                    <div class="row w-100 mx-0">
                        <div class="col-lg-4 mx-auto">
                            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                                ...
                                <?php if(Session::has('error_message')): ?> <!-- Check AdminController.php, login() method -->
                                ...
                                <form class="pt-3" action="<?php echo e(url('admin/login')); ?>" method="post">
                                    <?php echo csrf_field(); ?> 
...
</html><?php /**PATH C:\xampp\htdocs\multi-vendor\resources\views/admin/login.blade.php ENDPATH**/ ?>