...
<!--plugins-->
<link href="<?php echo e(asset('assets/plugins/OwlCarousel/css/owl.carousel.min.css')); ?>" rel="stylesheet" />
...
<title><?php echo $__env->yieldContent('title', 'Shopingo - eCommerce HTML Template'); ?></title>
...
<body>
	...
	<div class="wrapper">
        ...
        <?php echo $__env->make('front.layout.partials.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
       ...
       <?php echo $__env->yieldContent('sidebar'); ?>
        ...
        <?php echo $__env->make('front.layout.partials.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
							...
							<div class="col-12 col-lg-6">
								<div class="image-zoom-section">
									<div class="product-gallery owl-carousel owl-theme border mb-3 p-3" data-slider-id="1">
										<div class="item">
											<img src="<?php echo e(asset('assets/images/product-gallery/01')); ?>.png" class="img-fluid" alt="">
										</div>
										<div class="item">
											<img src="<?php echo e(asset('assets/images/product-gallery/02')); ?>.png" class="img-fluid" alt="">
										</div>
										<div class="item">
											<img src="<?php echo e(asset('assets/images/product-gallery/03')); ?>.png" class="img-fluid" alt="">
										</div>
										<div class="item">
											<img src="<?php echo e(asset('assets/images/product-gallery/04')); ?>.png" class="img-fluid" alt="">
										</div>
									</div>
									<div class="owl-thumbs d-flex justify-content-center" data-slider-id="1">
										<button class="owl-thumb-item">
											<img src="<?php echo e(asset('assets/images/product-gallery/01')); ?>.png" class="" alt="">
										</button>
										<button class="owl-thumb-item">
											<img src="<?php echo e(asset('assets/images/product-gallery/02')); ?>.png" class="" alt="">
										</button>
										<button class="owl-thumb-item">
											<img src="<?php echo e(asset('assets/images/product-gallery/03')); ?>.png" class="" alt="">
										</button>
										<button class="owl-thumb-item">
											<img src="<?php echo e(asset('assets/images/product-gallery/04')); ?>.png" class="" alt="">
										</button>
									</div>
								</div>
							</div>
...
<!-- Owl Carousel -->
<script src="<?php echo e(asset('assets/plugins/OwlCarousel/js/owl.carousel.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/plugins/OwlCarousel/js/owl.carousel2.thumbs.min.js')); ?>"></script>
...
</html><?php /**PATH C:\xampp\htdocs\multi-vendor\resources\views/front/layout/layout.blade.php ENDPATH**/ ?>