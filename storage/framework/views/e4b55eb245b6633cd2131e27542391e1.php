                    ...
                    <div class="item">
                        <div class="position-relative">
                            <div class="position-absolute top-50 slider-content translate-middle">
                                ...
                                <h1 class="h1 fw-bold"><?php echo e($banner['title']); ?></h1>
                                <p class="fw-bold text-dark d-none d-md-block"><i>Last call for upto 15%</i></p>
                                <div>
                                    <a class="btn btn-dark btn-ecomm px-4"
                                        <?php if(!empty($banner['link'])): ?> href="<?php echo e(url($banner['link'])); ?>"
                                   <?php else: ?>
                                       href="javascript:;" <?php endif; ?>>
                                        Shop Now
                                    </a>
                                </div>
                            </div>
                            ...
                            <?php else: ?>
                                href="javascript:;" <?php endif; ?>>
                                <img src="<?php echo e(asset('front/images/banner_images/' . $banner['image'])); ?>" class="img-fluid"
                                    alt="<?php echo e($banner['title']); ?>" title="<?php echo e($banner['title']); ?>">
                            </a>
                        </div>
                    </div>
                ...
                <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3 g-4">
                    <div class="col">
                        <div class="card rounded-0 shadow-none bg-info bg-opacity-25">
                            <div class="row g-0 align-items-center">
                                <div class="col">
                                    <img src="<?php echo e(asset('assets/images/promo/01.png')); ?>" class="img-fluid" alt="" />
                                </div>
                                <div class="col">
                                    <div class="card-body">
                    ...
                    <div class="col">
                        <div class="card rounded-0 shadow-none bg-danger bg-opacity-25">
                            <div class="row g-0 align-items-center">
                                <div class="col">
                                    <img src="<?php echo e(asset('assets/images/promo/02.png')); ?>" class="img-fluid" alt="" />
                                </div>
                                <div class="col">
                                    <div class="card-body">
                    ...
                    <div class="col">
                        <div class="card rounded-0 shadow-none bg-warning bg-opacity-25">
                            <div class="row g-0 align-items-center">
                                <div class="col">
                                    <img src="<?php echo e(asset('assets/images/promo/03.png')); ?>" class="img-fluid" alt="" />
                                </div>
                                <div class="col">
                                    <div class="card-body">
                                ...
                                <div class="card">
                                    <div class="position-relative overflow-hidden">
                                        <div class="add-cart position-absolute top-0 end-0 mt-3 me-3">
                                            <a href="<?php echo e($product_url); ?>"><i class='bx bx-cart-add'></i></a>
                                        </div>
                                        ...
                                        <a href="<?php echo e($product_url); ?>">
                                            <?php if(!empty($product['product_image']) && file_exists(public_path($product_image_path))): ?>
                                                <img src="<?php echo e(asset($product_image_path)); ?>" class="img-fluid"
                                    ...
                                    <div class="card-body px-0">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div>
                                                <p class="mb-1 product-short-name"><?php echo e($product['product_code']); ?></p>
                                                <h6 class="mb-0 fw-bold product-short-title">
                                                    <?php echo e($product['product_name']); ?></h6>
                                            </div>
                                ...
                                <div class="card">
                                    <div class="position-relative overflow-hidden">
                                        ...
                                        <a href="<?php echo e(url('product/' . $product['id'])); ?>">
                                            <img src="<?php echo e(asset('front/images/product_images/large/' . $product['product_image'])); ?>"
                                                class="img-fluid" alt="<?php echo e($product['product_name']); ?>">
                                        </a>
                                    </div>
                                    <div class="card-body px-0">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div>
                                                <p class="mb-1 product-short-name">
                                                    <?php echo e($product['category']['category_name'] ?? 'Product'); ?></p>
                                                <h6 class="mb-0 fw-bold product-short-title">
                                                    <?php echo e($product['product_name']); ?></h6>
                                            </div>
                                            <div class="icon-wishlist">
                                        ...
                                        <div
                                            ...
                                            <?php if($product['product_discount'] > 0): ?>
                                                ...
                                                <div class="h6 fw-bold">
                                                    $<?php echo e($product['product_price'] - ($product['product_price'] * $product['product_discount']) / 100); ?>

                                                </div>
                                            <?php else: ?>
                                                <div class="h6 fw-bold">$<?php echo e($product['product_price']); ?></div>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-2 row-cols-xl-4 g-4">
                        <div class="col d-flex">
                            <div class="card rounded-0 w-100 border-0 shadow-none">
                                <img src="<?php echo e(asset('assets/images/promo/04.png')); ?>" class="img-fluid" alt="...">
                        ...
                        <div class="col d-flex">
                            <div class="card rounded-0 w-100 border-0 shadow-none">
                                <img src="<?php echo e(asset('assets/images/promo/08.png')); ?>" class="img-fluid" alt="...">
                                <div class="position-absolute top-0 end-0 m-3 product-discount"><span
                                        class="">-80%</span>
                                </div>
                                <div class="card-body text-center">
                        ...
                        <div class="col d-flex">
                            <div class="card rounded-0 w-100 border-0 shadow-none">
                                <img src="<?php echo e(asset('assets/images/promo/06.png')); ?>" class="img-fluid h-100"
                                    alt="...">
                        ...
                        <div class="col d-flex">
                            <div class="card rounded-0 w-100 border-0 shadow-none">
                                ...
                                <img src="<?php echo e(asset('assets/images/promo/07.png')); ?>" class="img-fluid" alt="...">
                                <div class="card-body text-center">
                ...
                <div class="product-grid">
                    <div class="browse-category owl-carousel owl-theme">
                        <div class="item">
                            <div class="card rounded-0">
                                <div class="card-body p-0">
                                    <img src="<?php echo e(asset('assets/images/categories/01.png')); ?>" class="img-fluid"
                                        alt="...">
                                </div>
                        ...
                        <div class="item">
                            <div class="card rounded-0">
                                <div class="card-body p-0">
                                    <img src="<?php echo e(asset('assets/images/categories/02.png')); ?>" class="img-fluid"
                                        alt="...">
                                </div>
                                <div class="card-footer text-center bg-transparent border">
                        ...
                        <div class="item">
                            <div class="card rounded-0">
                                <div class="card-body p-0">
                                    <img src="<?php echo e(asset('assets/images/categories/03.png')); ?>" class="img-fluid"
                                        alt="...">
                                </div>
                                <div class="card-footer text-center bg-transparent border">
                        ...
                        <div class="item">
                            <div class="card rounded-0">
                                <div class="card-body p-0">
                                    <img src="<?php echo e(asset('assets/images/categories/04.png')); ?>" class="img-fluid"
                                        alt="...">
                                </div>
                                <div class="card-footer text-center bg-transparent border">
                        ...
                        <div class="item">
                            <div class="card rounded-0">
                                <div class="card-body p-0">
                                    <img src="<?php echo e(asset('assets/images/categories/05.png')); ?>" class="img-fluid"
                                        alt="...">
                                </div>
                                <div class="card-footer text-center bg-transparent border">
                        ...
                        <div class="item">
                            <div class="card rounded-0">
                                <div class="card-body p-0">
                                    <img src="<?php echo e(asset('assets/images/categories/06.png')); ?>" class="img-fluid"
                                        alt="...">
                                </div>
                                <div class="card-footer text-center bg-transparent border">
                        ...
                        <div class="item">
                            <div class="card rounded-0">
                                <div class="card-body p-0">
                                    <img src="<?php echo e(asset('assets/images/categories/07.png')); ?>" class="img-fluid"
                                        alt="...">
                                </div>
                                <div class="card-footer text-center bg-transparent border">
                        ...
                        <div class="item">
                            <div class="card rounded-0">
                                <div class="card-body p-0">
                                    <img src="<?php echo e(asset('assets/images/categories/08.png')); ?>" class="img-fluid"
                                        alt="...">
                                </div>
                                <div class="card-footer text-center bg-transparent border">
                        ...
                        <div class="item">
                            <div class="card rounded-0">
                                <div class="card-body p-0">
                                    <img src="<?php echo e(asset('assets/images/categories/09.png')); ?>" class="img-fluid"
                                        alt="...">
                                </div>
                                <div class="card-footer text-center bg-transparent border">
                        ...
                        <div class="item">
                            <div class="card rounded-0">
                                <div class="card-body p-0">
                                    <img src="<?php echo e(asset('assets/images/categories/10.png')); ?>" class="img-fluid"
                                        alt="...">
                                </div>
                                <div class="card-footer text-center bg-transparent border">
                        ...
                        <div class="item">
                            <div class="card rounded-0">
                                <div class="card-body p-0">
                                    <img src="<?php echo e(asset('assets/images/categories/11.png')); ?>" class="img-fluid"
                                        alt="...">
                                </div>
                                <div class="card-footer text-center bg-transparent border">
                        ...
                        <div class="item">
                            <div class="card rounded-0">
                                <div class="card-body p-0">
                                    <img src="<?php echo e(asset('assets/images/categories/12.png')); ?>" class="img-fluid"
                                        alt="...">
                                </div>
                                <div class="card-footer text-center bg-transparent border">
                    ...
                    <div class="latest-news owl-carousel owl-theme">
                        <div class="item">
                            <div class="card rounded-0 product-card border">
                                ...
                                <a href="javascript:;">
                                    <img src="<?php echo e(asset('assets/images/blogs/01.png')); ?>"
                        ...
                        <div class="item">
                            <div class="card rounded-0 product-card border">
                                ...
                                <a href="javascript:;">
                                    <img src="<?php echo e(asset('assets/images/blogs/02.png')); ?>"
                                        class="card-img-top border-bottom" alt="...">
                                </a>
                                <div class="card-body">
                                    <div class="news-title">
                        ...
                        <div class="item">
                            <div class="card rounded-0 product-card border">
                                ...
                                <a href="javascript:;">
                                    <img src="<?php echo e(asset('assets/images/blogs/03.png')); ?>"
                                        class="card-img-top border-bottom" alt="...">
                                </a>
                                <div class="card-body">
                                    <div class="news-title">
                        ...
                        <div class="item">
                            <div class="card rounded-0 product-card border">
                                ...
                                <a href="javascript:;">
                                    <img src="<?php echo e(asset('assets/images/blogs/04.png')); ?>"
                                        class="card-img-top border-bottom" alt="...">
                                </a>
                                <div class="card-body">
                                    <div class="news-title">
                        ...
                        <div class="item">
                            <div class="card rounded-0 product-card border">
                                ...
                                <a href="javascript:;">
                                    <img src="<?php echo e(asset('assets/images/blogs/05.png')); ?>"
                                        class="card-img-top border-bottom" alt="...">
                                </a>
                                <div class="card-body">
                                    <div class="news-title">
                        ...
                        <div class="item">
                            <div class="card rounded-0 product-card border">
                                ...
                                <a href="javascript:;">
                                    <img src="<?php echo e(asset('assets/images/blogs/06.png')); ?>"
                                        class="card-img-top border-bottom" alt="...">
                                </a>
                                <div class="card-body">
                                    <div class="news-title">
                ...
                <div class="brand-grid">
                    <div class="brands-shops owl-carousel owl-theme border">
                        <div class="item border-end">
                            <div class="p-4">
                                <a href="javascript:;">
                                    <img src="<?php echo e(asset('assets/images/brands/01.png')); ?>" class="img-fluid"
                                        alt="...">
                                </a>
                            </div>
                        </div>
                        <div class="item border-end">
                            <div class="p-4">
                                <a href="javascript:;">
                                    <img src="<?php echo e(asset('assets/images/brands/02.png')); ?>" class="img-fluid"
                                        alt="...">
                                </a>
                            </div>
                        </div>
                        <div class="item border-end">
                            <div class="p-4">
                                <a href="javascript:;">
                                    <img src="<?php echo e(asset('assets/images/brands/03.png')); ?>" class="img-fluid"
                                        alt="...">
                                </a>
                            </div>
                        </div>
                        <div class="item border-end">
                            <div class="p-4">
                                <a href="javascript:;">
                                    <img src="<?php echo e(asset('assets/images/brands/04.png')); ?>" class="img-fluid"
                                        alt="...">
                                </a>
                            </div>
                        </div>
                        <div class="item border-end">
                            <div class="p-4">
                                <a href="javascript:;">
                                    <img src="<?php echo e(asset('assets/images/brands/05.png')); ?>" class="img-fluid"
                                        alt="...">
                                </a>
                            </div>
                        </div>
                        <div class="item border-end">
                            <div class="p-4">
                                <a href="javascript:;">
                                    <img src="<?php echo e(asset('assets/images/brands/06.png')); ?>" class="img-fluid"
                                        alt="...">
                                </a>
                            </div>
                        </div>
                        <div class="item border-end">
                            <div class="p-4">
                                <a href="javascript:;">
                                    <img src="<?php echo e(asset('assets/images/brands/07.png')); ?>" class="img-fluid"
                                        alt="...">
                                </a>
                            </div>
                        </div>
                ...
                <div class="row row-cols-1 row-cols-md-2 row-cols-xl-4">
                    <div class="col">
                        <div class="bestseller-list mb-3">
                            ...
                            <?php $__currentLoopData = array_slice($bestSellers, 0, 4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <hr>
                                <div class="d-flex align-items-center gap-3">
                                    <div class="bottom-product-img">
                                        <a href="<?php echo e(url('product/' . $item['id'])); ?>">
                                            <img src="<?php echo e(asset('front/images/product_images/small/' . $item['product_image'])); ?>"
                                                width="80" alt="<?php echo e($item['product_name']); ?>">
                                        </a>
                                    </div>
                                    <div>
                                        <h6 class="mb-0 fw-light mb-1 fw-bold"><?php echo e($item['product_name']); ?></h6>
                                        <div class="rating">
                                            <i class="bx bxs-star text-warning"></i>
                                            <i class="bx bxs-star text-warning"></i>
                                            <i class="bx bxs-star text-warning"></i>
                                        ...
                                        <p class="mb-0 pro-price">
                                            <strong>
                                                <?php if($item['product_discount'] > 0): ?>
                                                    $<?php echo e($item['product_price'] - ($item['product_price'] * $item['product_discount']) / 100); ?>
                    ...
                    <div class="col">
                        <div class="featured-list mb-3">
                            ...
                            <?php $__currentLoopData = array_slice($featuredProducts, 0, 4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <hr>
                                <div class="d-flex align-items-center gap-3">
                                    <div class="bottom-product-img">
                                        <a href="<?php echo e(url('product/' . $item['id'])); ?>">
                    ...
                    <div class="col">
                        <div class="new-arrivals-list mb-3">
                            ...
                            <?php $__currentLoopData = array_slice($newProducts, 0, 4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <hr>
                                <div class="d-flex align-items-center gap-3">
                                    <div class="bottom-product-img">
                                        <a href="<?php echo e(url('product/' . $item['id'])); ?>">
                    ...
                    <div class="col">
						<div class="top-rated-products-list mb-3">
							...
							<?php $__currentLoopData = array_slice($discountedProducts, 0, 4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<hr>
								<div class="d-flex align-items-center gap-3">
									<div class="bottom-product-img">
										<a href="<?php echo e(url('product/' . $item['id'])); ?>">
											<img src="<?php echo e(asset('front/images/product_images/small/' . $item['product_image'])); ?>" width="80" alt="<?php echo e($item['product_name']); ?>">
										</a>
									</div>
									<div class="ms-0">
										<h6 class="mb-0 fw-light mb-1 fw-bold"><?php echo e($item['product_name']); ?></h6>
...
<?php echo $__env->make('front.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\multi-vendor\resources\views/front/index.blade.php ENDPATH**/ ?>